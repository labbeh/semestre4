...
public class TraitementImage {
	...
	public void redimensionnerImage () {
		int longueur = this.dimensions.width;
		int hauteur  = this.dimensions.height; 
		
		BufferedImage scrCapt = this.img;
		AffineTransform atscr = new AffineTransform();
		
		//double ratioX = (double)(this.img.getWidth() / longueur);
		//double ratioY = (double)(this.img.getHeight()/ hauteur );
		double ratioX = 1.0;
		double ratioY = 1.0;
