public class Coordonnees
{
	...
	public void setX ( double x ) { this.x = (x<MAX_XY && x>MIN_XY ? x : ( x>MAX_XY ? MAX_XY : MIN_XY )); }
	public void setY ( double y ) { this.y = (y<MAX_XY && y>MIN_XY ? y : ( x>MAX_XY ? MAX_XY : MIN_XY )); }
