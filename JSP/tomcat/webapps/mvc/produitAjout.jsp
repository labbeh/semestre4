...
<%	// ==============  CORPS =================================================
	...
	out.println("	<td> <input name=np > </td>");
	out.println("	<td> <input name=lib > </td>");
	out.println("	<td> <input name=coul > </td>");
	out.println("	<td> <input name=qs > </td>");
	...
	out.println("	<input type=hidden name=cmd value=ajoutProduitValid>");
