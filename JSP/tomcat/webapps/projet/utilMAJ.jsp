...
<%	// ==============  CORPS =================================================
	...
	out.println("<center><h3>mise a jour Utilisateur</h3></center>");
	...
	out.println("	<td><input name=role value="+u.getRole()+"></td>");
	out.println("	</tr>");
	out.println("	<tr>");
	out.println("	<td colspan=4><input type=submit value=valider></td>");
	out.println("	</tr>");

	out.println("	<input type=hidden name=idu value="+u.getIdu()+">");
