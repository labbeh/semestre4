 ...
 * Generated at: 2019-02-25 13:41:44 UTC
...
public final class suite_jsp extends org.apache.jasper.runtime.HttpJspBase
...
//on fait appel a la servlet qui va controler la session
      ...
      out.write('\n');
      org.apache.jasper.runtime.JspRuntimeLibrary.include(request, response, "/controle", out, false);
      out.write('\n');
      out.write('\n');
	...
	if(b != null && b == false){
		...
		if(droit == 1) out.println("Vous ̻tes connect̩ en mode consultation");
		else		   out.println("Vous ̻tes connect̩ en tant qu'administrateur");
