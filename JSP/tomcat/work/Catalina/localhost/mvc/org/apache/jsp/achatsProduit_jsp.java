 ...
 * Generated at: 2019-03-11 13:20:31 UTC
...
public final class achatsProduit_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/ihm/miseEnPagePAC1.jsp", Long.valueOf(1551695004000L));
 ...
 String titre="LISTE DES ACHATS du produit "+produit.getNp() +","+ produit.getLib(); 
	...
	boolean afficheMenuAdmin = true; //si ce boolÃ©en vaut vrai, le sous-menu dÃ©diÃ© Ã  l'administration sera affichÃ©
	
	/* A COMPLETER
	 * En utilisant la session (attribut droit), mettre Ã  jour la variable afficheMenuAdmin
	 * pour que le sous-menu dÃ©diÃ© Ã  l'administration ne soit affichÃ© que si l'utilisateur connectÃ©
	...
	if (DEBUG) {
      ...
      out.write("\t    <li><a href=\"controleur?cmd=ajoutProduit\"> Ajouter un produit (A FAIRE) </a></li>\n");
      out.write("\t    <li><a href=\"\"> </a></li>\n");
      out.write("\t  </ul>\n");
      out.write("\t  ");
